...
class TestHBNBCommand_prompt(unittest.TestCase):
    ...
    def testingPromptString(self):
        self.assertEqual("(hbnb) ", HBNBCommand.prompt)

    def test_docstringsInTestConsole(self):
        """Test docstrings exist in test_console.py"""
        self.assertTrue(len(self.__doc__) >= 1)

    def test_docstrings_inConsole(self):
        """Test docstrings exist in console.py"""
        self.assertTrue(len(console.__doc__) >= 1)

    def test_pep8_testConsole(self):
...
class TestHBNBCommand_Update(unittest.TestCase):
    ...
    def test_update_invalid_idSpaceNotation(self):
    ...
    def test_update_missing_id_spaceNotation(self):
